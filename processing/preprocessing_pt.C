...
void preprocessing_pt() {
    ...
    // Define file names
    std::string scaledMCFileName = "output_MCSCALEDRun2_tagprobe_test5.root";
    std::string unscaledMCFileName = "output_MCRun2_tagprobe_test4.root";
    std::string dataFileName = "output_DATARun2_tagprobe_test4.root";
    std::string outputFileName = "processed_histograms_pt.root";
