...
void Wqq_Mass() {
    ...
    h3gencstagx->GetYaxis()->SetRangeUser(0, 0.05);
    ...
    h3genudtagx->GetYaxis()->SetRangeUser(0, 0.05);
    ...
    h3genxtagx->GetYaxis()->SetRangeUser(0, 0.05);
    ...
    h3tagxall->GetYaxis()->SetRangeUser(0, 0.05); // Adjust the range as needed
    ...
    h3gencstagud->GetYaxis()->SetRangeUser(0, 0.05); // Adjust the range as needed
    ...
    h3genudtagud->SetTitle("");
        ...
        // Set the x-axis range
    h3genudtagud->GetXaxis()->SetRangeUser(55, 115);
    h3genudtagud->GetYaxis()->SetRangeUser(0, 0.05);  // Adjust the range as needed
    ...
    h3genxtagud->SetTitle("");
        ...
        // Set the x-axis range
    h3genxtagud->GetXaxis()->SetRangeUser(55, 115);
    h3genxtagud->GetYaxis()->SetRangeUser(0, 0.05); // Adjust the range as needed
    ...
    h3tagudall->GetYaxis()->SetRangeUser(0, 0.05); // Adjust the range as needed
    ...
    h3gencstagcs->GetYaxis()->SetRangeUser(0, 0.05); // Adjust the range as needed
    ...
    h3genudtagcs->GetYaxis()->SetRangeUser(0, 0.05);
    ...
    h3genxtagcs->GetYaxis()->SetRangeUser(0, 0.05); // Adjust the range as needed
    ...
    h3tagcsall->GetYaxis()->SetRangeUser(0, 0.05); // Adjust the range as needed
    ...
    h3gencsall->SetTitle("");
        ...
        // Set the x-axis range
    h3gencsall->GetXaxis()->SetRangeUser(55, 115);
    h3gencsall->GetYaxis()->SetRangeUser(0, 0.05); // Adjust the range as needed
    ...
    h3genudall->SetTitle("");
        ...
        // Set the x-axis range
    h3genudall->GetXaxis()->SetRangeUser(55, 115);
    h3genudall->GetYaxis()->SetRangeUser(0, 0.05); // Adjust the range as needed
    ...
    h3genxall->GetYaxis()->SetRangeUser(0, 0.05);
...
setTDRStyle();
    ...
    h_tagcsvsdata->GetYaxis()->SetRangeUser(0, 2); // Adjust the range as needed
    ...
    h_tagudvsdata->GetYaxis()->SetRangeUser(0, 2); // Adjust the range as needed
    ...
    h_tagxvsdata->GetYaxis()->SetRangeUser(0, 2); // Adjust the range as needed
    ...
    h_allvsdata->GetYaxis()->SetRangeUser(0, 2); // Adjust the range as needed
