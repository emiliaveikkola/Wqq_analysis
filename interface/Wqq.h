...
// Mon Oct 14 12:23:55 2024 by ROOT version 6.32.06
...
Int_t Wqq::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Wqq::LoadTree(Long64_t entry)
{
