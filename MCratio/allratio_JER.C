...
void allratio_JER() {
    ...
    TFile* outputFile = new TFile("processed_histograms/histograms_JER.root", "RECREATE");
    ...
    std::vector<std::string> suffixes = {"JER080", "JER090", "JER110", "JER120"};
    ...
    c2->SaveAs("pdf/all_ratio_JER.pdf");
